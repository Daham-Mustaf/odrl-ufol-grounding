; --------------------------------------------------------------------------
; File     : GRND036-dual-rule-distinct-relators-1.smt2
...
(declare-const distrib     NormContent)
...
(declare-const rho-r1      Relator) (declare-const rho-r2    Relator)
; pol1 and pol2 are distinct rules
(assert (not (= pol1 pol2)))
; pol1 remedy relator
...
(assert (founds-rem e2 rho-r2 pol2))

; === Negated conjecture ===
(assert (not (distinct rho-r1 rho-r2)))
