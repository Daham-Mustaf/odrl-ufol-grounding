...
% Domain   : Foundational Ontology (UFO-L) / Deontic ODRL Grounding% Problem  : B2+B3: Power and Subjection in relator concern founding event
% Status   : Theorem
% Refs     : Mustafa et al., What Does ODRL Mean? A Cross-Level Ontological Grounding of Permissions, Prohibitions, and Duties in UFO-L (FOIS 2026)% Policy   : Policies/GRND018-about-event-policy.ttl
